...
- Comparing the payment methods over sales.
- Which city has the highest sales?
- Which customer type should be favor?
- Who purchased more - Male or Female?
- Dashboard Interactive <a href="https://github.com/myolwinhein-data/Supermarket-Sale-Analysis-Power-BI-/blob/main/Screenshot%202026-02-16%20234444.png">View Dashboard</a>

## Process
- Verify data for any missing values and sort the data.
- Made sure data is consistent and clean with respect to data type,data format and values used.
- Create Starschema for the relationship and use dax function for dynamic calculations.
- Apply slicer to make dynamic and create charts to get useful insights.
